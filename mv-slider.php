 ...
 * Plugin URI: https://www.alphega.nl/wordpress-plugins/mv-slider
 * Description: My plugin's description
 * Version: 1.0
 * Requires at least: 5.6
 * Author: Jeroen de Bruijn
 * Author URI: https://www.alphega.nl
...
/*
 * MV Slider is free...
 * more license info blabla....
 */

if (!defined('ABSPATH')) {
	die('This plugin cannot be accessed directly!');
	//exit;
}

// You can also use function_exists for function only plugins
if (!class_exists('MV_Slider')) {
	class MV_Slider {
		...
		public static function uninstall() {
			// Can also be a separate file: uninstall.php in teh root folder of the plugin.
		...
		public function mv_slider_get_placeholder_image() {
